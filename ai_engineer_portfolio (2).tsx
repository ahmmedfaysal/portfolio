  ...
  const education = [
    {
      ...
      achievements: [
        ...
        'Outstanding Thesis Award in Machine Learning',
    ...
    },
    {
      ...
      description: 'Led the University AI & Robotics club, developing predictive models for autonomous navigation.',
      achievements: [
        ...
        <section id="home" className="min-h-[90vh] flex flex-col justify-center relative pt-20">
          <div className="relative z-10 mt-10">
            ...
            <Reveal delay={0.1}>
              ...
              <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-[#9b4819]/30 bg-white/50 backdrop-blur-md mb-8 shadow-sm">
                <Sparkles size={16} className="text-[#9b4819]" />
                <span className="text-sm font-mono text-[#9b4819] uppercase tracking-wider font-semibold">
                  Applied AI Engineer
                </span>
              </div>
            </Reveal>
            ...
            <div className="glass-panel p-10 md:p-16 rounded-[2.5rem] bg-white/70 shadow-lg border border-white/80 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center relative z-10">
                    ...
                    <div className="flex flex-col items-start lg:items-end justify-center h-full">
                         <a href="mailto:faysal.ahmmed@example.com" className="inline-flex items-center gap-3 px-8 py-5 bg-[#1C1B19] text-[#f4f1e8] rounded-full font-medium hover:bg-[#9b4819] transition-all hover:scale-105 active:scale-95 shadow-xl shadow-[#1C1B19]/10 text-lg">
                            <Mail size={20} />
                            Send a Message
                        </a>
                    </div>
            ...
            return (
              <button
                ...
                className={`relative group flex items-center justify-center w-12 h-12 rounded-full transition-all duration-400 ease-out focus:outline-none ${
                  isActive 
                    ? 'bg-[#1C1B19]/90 shadow-md scale-[1.15]' // Dark active state like Apple Dock items
                    : 'hover:bg-white/80 hover:scale-110'
                }`}
              >
                <Icon 
                  size={isActive ? 22 : 20} 
                  className={`transition-colors duration-300 ${isActive ? 'text-[#f4f1e8]' : 'text-stone-600 group-hover:text-[#1C1B19]'}`} 
