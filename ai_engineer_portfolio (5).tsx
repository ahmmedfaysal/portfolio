...
export default function Portfolio() {
  ...
  const experience = [
    ...
    },
    {
      ...
      date: '2021 — 2023',
      description: 'Developed scalable recommendation engines and deployed computer vision models to edge devices. Collaborated with data engineering teams to establish MLOps best practices and automated CI/CD pipelines.'
    }
  ];
  ...
  const education = [
    {
      ...
      description: 'Led the University AI & Robotics club, developing predictive models for autonomous navigation. Core focus on Data Structures, Algorithms, and Machine Learning.',
      achievements: [
        'Graduated with Summa Cum Laude',
        'Dean\'s Honor List (2018, 2019, 2020)',
        '1st Runner Up at National AI Hackathon 2020'
      ]
    }
  ];
  ...
  const extracurriculars = [
    {
      ...
      rating: 'Max Rating: 1950 (Candidate Master)',
      description: 'Regularly participate in Div 1 and Div 2 contests. Solved over 1000 algorithmic problems focusing on dynamic programming, graph theory, and advanced data structures.',
      icon: <SiCodeforces size={24} className="text-[#1f8acb]" /> // Codeforces Blue
    },
    {
      platform: 'ICPC (International Collegiate Programming Contest)',
      role: 'Team Lead & Strategist',
      rating: 'Regional Finalist',
      description: 'Led a 3-person team to the Regional Finals two years consecutively. Responsible for algorithm design and debugging under intense time constraints.',
      icon: <Trophy size={24} className="text-[#9b4819]" />
    },
    {
      platform: 'CodeChef',
      role: 'Competitive Programmer',
      rating: '5 Star',
      description: 'Achieved 5-star rating through consistent performance in long challenges and cook-offs.',
      icon: <SiCodechef size={24} className="text-[#5B4638]" /> // Codechef brown
    }
  ];
    ...
    <div className="relative w-full min-h-screen selection:bg-[#9b4819] selection:text-[#f4f1e8]">
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .glass-dock {
          ...
          box-shadow: 0 8px 32px rgba(0, 0, 0, 0.08), 0 1px 2px rgba(255, 255, 255, 0.4) inset;
        }
      ...
      <div className="ambient-bg">
        <div className="absolute top-1/4 left-1/4 w-[30rem] h-[30rem] bg-[#9b4819] rounded-full mix-blend-multiply filter blur-[120px] opacity-[0.15] animate-blob"></div>
        <div className="absolute bottom-1/4 right-1/4 w-[30rem] h-[30rem] bg-[#d97c45] rounded-full mix-blend-multiply filter blur-[150px] opacity-[0.12] animate-blob animation-delay-4000"></div>
      </div>
      ...
      <main className="max-w-5xl mx-auto px-6 md:px-12 pb-32 relative z-10">
        ...
        <section id="home" className="min-h-[90vh] flex flex-col justify-center relative pt-20">
          <div className="relative z-10 mt-10">
            ...
            <Reveal delay={0.1}>
              ...
              <div className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border border-[#9b4819]/30 bg-white/50 backdrop-blur-md mb-8 shadow-sm">
                <span className="text-lg md:text-xl font-serif text-[#9b4819] tracking-wide font-medium">
                  Applied AI Engineer
                </span>
              </div>
            </Reveal>
        ...
        <section id="about" className="py-24 md:py-32 scroll-mt-12">
          ...
          <div className="flex flex-col gap-6">
            ...
            <Reveal delay={0.2}>
              <div className="glass-panel p-8 md:p-12 rounded-[2rem] bg-white/60 relative overflow-hidden">
                {/* Subtle side accent */}
                <div className="absolute left-0 top-0 bottom-0 w-2 bg-[#9b4819]/80"></div>
                
                <div className="flex items-center gap-3 mb-8 ml-2">
                  <Terminal size={28} className="text-[#9b4819]" />
                  <h3 className="text-3xl font-serif text-stone-900">Core Technologies</h3>
                </div>
                
                {/* Categorized Stack for better layout */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 ml-2">
                    <div>
                        <h4 className="text-sm font-mono text-stone-500 uppercase tracking-wider mb-4 border-b border-stone-200 pb-2">AI / ML / Data</h4>
                        <div className="flex flex-wrap gap-2.5">
                        {['Python', 'PyTorch', 'Transformers', 'LangChain', 'HuggingFace', 'Qdrant'].map((tech) => (
                    ...
                    <div>
                        <h4 className="text-sm font-mono text-stone-500 uppercase tracking-wider mb-4 border-b border-stone-200 pb-2">Engineering / DevOps</h4>
                        <div className="flex flex-wrap gap-2.5">
                        {['Next.js', 'TypeScript', 'FastAPI', 'AWS', 'Docker', 'Ray'].map((tech) => (
                            <span key={tech} className="px-4 py-2 bg-stone-900 text-[#f4f1e8] rounded-xl text-sm font-mono shadow-md hover:bg-[#9b4819] hover:-translate-y-0.5 transition-all cursor-default">
                            {tech}
                            </span>
                        ))}
        ...
        <div id="journey" className="scroll-mt-12">
          ...
          <section className="py-20">
            <Reveal>
              <div className="flex items-center gap-4 mb-12">
                ...
                <Milestone className="w-10 h-10 text-[#9b4819]" />
                <h2 className="text-4xl md:text-5xl font-serif text-stone-900">Experience</h2>
              </div>
            </Reveal>
            
            <div className="max-w-4xl border-l-2 border-[#9b4819]/30 ml-4 md:ml-5 space-y-16 pb-4">
          ...
          <section className="py-20">
            <Reveal>
              <div className="flex items-center gap-4 mb-12">
                 {/* Resized Icon */}
                <GraduationCap className="w-10 h-10 text-[#9b4819]" />
              ...
              {education.map((edu, idx) => (
                <Reveal key={idx} delay={idx * 0.1}>
                  <div className="relative pl-10 md:pl-16">
                    ...
                    <p className="text-stone-700 leading-relaxed font-light text-lg mb-4">{edu.description}</p>
                        ...
                        <ul className="space-y-2 mt-4">
                            {edu.achievements.map((achievement, i) => (
                                <li key={i} className="flex items-start gap-2">
                                    <CheckCircle2 size={18} className="text-[#9b4819] mt-1 flex-shrink-0" />
                                    <span className="text-stone-600 font-light text-lg">{achievement}</span>
                                </li>
                            ))}
                        </ul>
                    )}
          ...
          <section className="py-20">
            <Reveal>
              <div className="flex items-center gap-4 mb-12">
                {/* Resized Icon */}
                <Award className="w-10 h-10 text-[#9b4819]" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {certifications.map((cert, idx) => (
                <Reveal key={idx} delay={idx * 0.1}>
                  <div className="group relative p-6 md:p-8 rounded-[1.5rem] bg-white/40 border border-stone-200 hover:border-[#9b4819]/50 transition-colors duration-300 overflow-hidden shadow-sm hover:shadow-md h-full flex flex-col">
          ...
          <section className="py-20">
            <Reveal>
              <div className="flex items-center gap-4 mb-12">
                 {/* Resized Icon */}
                <Trophy className="w-10 h-10 text-[#9b4819]" />
                <h2 className="text-4xl md:text-5xl font-serif text-stone-900">Extracurriculars</h2>
              </div>
            </Reveal>
                  ...
                  <div className="relative pl-10 md:pl-16">
                    ...
                    <div className="flex flex-col md:flex-row md:items-baseline gap-2 md:gap-4 mb-2">
                      <div className="flex items-center gap-3">
                        {extra.icon}
                        <h3 className="text-2xl font-medium text-stone-900">{extra.platform}</h3>
                      </div>
                    </div>
                    <div className="text-xl text-[#9b4819] font-serif italic mb-4">{extra.role}</div>
                    
                    <div className="flex flex-wrap gap-4 mb-5 items-center">
                      <span className="inline-block px-3 py-1 bg-[#1C1B19] text-[#f4f1e8] border border-stone-700 rounded font-mono text-sm shadow-sm">
                        {extra.rating}
                      </span>
                    </div>
                    
                    <p className="text-stone-700 leading-relaxed font-light text-lg">{extra.description}</p>
                  </div>
                </Reveal>
              ))}
            </div>
        ...
        <section id="contact" className="py-32 mb-20 flex flex-col scroll-mt-12">
          <Reveal>
            <div className="glass-panel p-10 md:p-16 rounded-[2.5rem] bg-white/70 shadow-lg border border-white/80 relative overflow-hidden">
                {/* Decorative background element inside contact card */}
                <div className="absolute -bottom-32 -right-32 w-64 h-64 bg-[#9b4819]/10 rounded-full blur-[80px]"></div>
                
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center relative z-10">
                    
                    {/* Left Column: Heading and Text */}
                    <div>
                        <h2 className="text-5xl md:text-6xl font-serif mb-6 text-stone-900 tracking-tight">Let's build<br/>together.</h2>
                        <p className="text-lg md:text-xl text-stone-600 font-light leading-relaxed mb-8 max-w-md">
                        ...
                        {/* European standard simple minimal details */}
                        <div className="space-y-4">
                            <div className="flex items-center gap-4 text-stone-700 group">
                                <div className="w-10 h-10 rounded-full bg-[#f4f1e8] border border-stone-200 flex items-center justify-center group-hover:border-[#9b4819] transition-colors">
                                    <Mail size={18} className="text-stone-500 group-hover:text-[#9b4819]" />
                                </div>
                                <a href="mailto:example@gmail.com" className="font-mono text-[15px] hover:text-[#9b4819] transition-colors">faysal.ahmmed@example.com</a>
                            </div>
                            <div className="flex items-center gap-4 text-stone-700 group">
                                <div className="w-10 h-10 rounded-full bg-[#f4f1e8] border border-stone-200 flex items-center justify-center group-hover:border-[#9b4819] transition-colors">
                                    <Phone size={18} className="text-stone-500 group-hover:text-[#9b4819]" />
                                </div>
                                <a href="tel:+440123456789" className="font-mono text-[15px] hover:text-[#9b4819] transition-colors">+44 (0) 1234 567 890</a>
                            </div>
                            <div className="flex items-center gap-4 text-stone-700 group">
                                <div className="w-10 h-10 rounded-full bg-[#f4f1e8] border border-stone-200 flex items-center justify-center group-hover:border-[#9b4819] transition-colors">
                                    <MapPin size={18} className="text-stone-500 group-hover:text-[#9b4819]" />
                                </div>
                                <span className="font-mono text-[15px]">London, United Kingdom</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-start lg:items-end justify-center h-full gap-4">
                         <a href="mailto:faysal.ahmmed@example.com" className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-[#1C1B19] text-[#f4f1e8] rounded-full font-medium hover:bg-[#9b4819] transition-all hover:scale-105 active:scale-95 shadow-xl shadow-[#1C1B19]/10 text-lg w-full sm:w-auto min-w-[260px]">
                            <Mail size={20} />
                            Send a Message
                        </a>
                        <a href="https://wa.me/440123456789" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-[#1C1B19] border border-stone-200 rounded-full font-medium hover:border-[#25D366] hover:text-[#25D366] hover:bg-stone-50 transition-all hover:scale-105 active:scale-95 shadow-md text-lg w-full sm:w-auto min-w-[260px]">
                            <SiWhatsapp size={20} />
                            WhatsApp Contact
                        </a>
                    </div>
            ...
            return (
              <button
                ...
                className={`relative group flex flex-col items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-full transition-all duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] focus:outline-none ${
                  isActive 
                    ? 'bg-white/60 shadow-[0_4px_12px_rgba(0,0,0,0.05)] scale-110' // Smooth active state
              ...
              >
                <div className="relative flex items-center justify-center w-full h-full">
                    <Icon 
                    size={isActive ? 24 : 22} 
                    className={`transition-colors duration-400 ${isActive ? 'text-[#9b4819]' : 'text-stone-600 group-hover:text-[#1C1B19]'}`} 
                    strokeWidth={isActive ? 2.5 : 2}
                    />
                    
                    {/* Active Indicator Dot (Apple Style) */}
                    {isActive && (
                    <span className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full bg-[#9b4819]"></span>
                    )}
                </div>

                {/* Minimalist Tooltip matching Apple styling */}
                <span className="absolute -top-14 left-1/2 -translate-x-1/2 bg-[#1C1B19]/90 backdrop-blur-md text-[#f4f1e8] text-[12px] font-medium tracking-wide px-3.5 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none transform translate-y-2 group-hover:translate-y-0 whitespace-nowrap shadow-xl">
                  {item.label}
                  {/* Tooltip little triangle pointer */}
                  <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-[#1C1B19]/90 rotate-45"></div>
                </span>
              </button>
            );
          })}
