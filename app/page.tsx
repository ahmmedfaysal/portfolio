        ...
        <section id="home" className="min-h-[90vh] flex flex-col justify-center relative pt-20">
          <div className="relative z-10 mt-10">
            ...
            <Reveal delay={0.1}>
              ...
              <div className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border-2 border-[#9b4819]/30 bg-white/50 backdrop-blur-md mb-8 shadow-sm">
  <span className="text-xl md:text-2xl font-serif text-[#9b4819] tracking-wide font-medium italic">
    Applied AI Engineer
  </span>
</div>
            </Reveal>
            ...
            <Reveal delay={0.3}>
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div className="flex gap-3 ml-2">
                  <a href="https://github.com/ahmmedfaysal" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="relative group p-3.5 rounded-full border border-stone-300 bg-white/40 backdrop-blur-sm hover:bg-[#9b4819] hover:border-[#9b4819] hover:text-[#f4f1e8] transition-all text-stone-700">
                    <GitHubIcon size={20} />
                  ...
                  <a href="https://www.linkedin.com/in/faysal-ahmmed-65b68b240" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="relative group p-3.5 rounded-full border border-stone-300 bg-white/40 backdrop-blur-sm hover:bg-[#9b4819] hover:border-[#9b4819] hover:text-[#f4f1e8] transition-all text-stone-700">
                  ...
                  <a href="https://scholar.google.com/citations?user=K6V0gzsAAAAJ&hl=en" target="_blank" rel="noopener noreferrer" aria-label="Google Scholar" className="relative group p-3.5 rounded-full border border-stone-300 bg-white/40 backdrop-blur-sm hover:bg-[#9b4819] hover:border-[#9b4819] hover:text-[#f4f1e8] transition-all text-stone-700">
                    <ScholarIcon size={20} />
                    <span className="absolute -top-14 left-1/2 -translate-x-1/2 bg-[#1C1B19]/90 backdrop-blur-md text-[#f4f1e8] text-[12px] font-medium tracking-wide px-3.5 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none transform translate-y-2 group-hover:translate-y-0 whitespace-nowrap shadow-xl z-50">
                      Google Scholar
                      <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-[#1C1B19]/90 rotate-45"></div>
            ...
            <Reveal delay={0.2}>
              <div className="glass-panel p-8 md:p-12 rounded-[2rem] bg-white/60 relative overflow-hidden">
                ...
                <div className="flex items-center gap-3 mb-8 ml-2">
                  ...
                  <h3 className="text-3xl font-serif text-stone-900">Technical Expertise</h3>
                </div>
              ...
              {experience.map((exp, idx) => (
                <Reveal key={idx} delay={idx * 0.1}>
                  <div className="relative pl-10 md:pl-16">
                    ...
                    {/* Role Name On Top */}
                    <h3 className="text-2xl font-semibold tracking-tight text-stone-900 mb-1.5">
                      {exp.role}
                    </h3>
          
                  {/* Company Name and Period Side-by-Side (Big Tech Standard) */}
                  <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mb-5">
                    <span className="text-[#9b4819] font-serif italic text-xl font-medium">
                      {exp.company}
                    </span>
                ...
                <Reveal key={idx} delay={idx * 0.1}>
                  <div className="relative pl-10 md:pl-16">
                    ...
                    <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mb-4">
                      <span className="text-xl text-[#9b4819] font-serif italic font-medium">
                        {edu.institution}
                      </span>
                      <span className="text-stone-400 font-light">•</span>
                      <span className="inline-block px-3 py-1 bg-white/60 border border-stone-200 rounded text-sm font-mono text-stone-600 shadow-sm">
                    ...
                    <div className="mb-6 bg-white/30 border border-stone-200/60 rounded-2xl p-5 backdrop-blur-sm">
  <p className="text-stone-700 font-light leading-relaxed text-lg">
    <strong className="font-medium text-[#9b4819]">Thesis: </strong>Developed an audio source separation model utilizing a hybrid Vision Transformer (ViTs) and U-Net architecture from mixed audio input.
  </p>
</div>
          ...
          <section className="py-20">
            <Reveal>
              <div className="flex items-center gap-4 mb-12">
                ...
                <h2 className="text-4xl md:text-5xl font-serif text-stone-900">Competitive Programming</h2>
              </div>
            </Reveal>
                    ...
                    <div className="flex flex-col items-start lg:items-end justify-center h-full gap-4">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-4 text-stone-700 group">
                                ...
                                <a href="mailto:ahmmedfaysal106@gmail.com" className="font-mono text-[15px] hover:text-[#9b4819] transition-colors">ahmmedfaysal106@gmail.com</a>
                            </div>
                            <div className="flex items-center gap-4 text-stone-700 group">
                                <div className="w-10 h-10 rounded-full bg-[#f4f1e8] border border-stone-200 flex items-center justify-center group-hover:border-[#9b4819] transition-colors">
                                    <Phone size={18} className="text-stone-500 group-hover:text-[#9b4819]" />
                                </div>
                                <a href="tel:+8801813113512" className="font-mono text-[15px] hover:text-[#9b4819] transition-colors">+880 1813-113512</a>
                            </div>
                            <div className="flex items-center gap-4 text-stone-700 group">
                                <div className="w-10 h-10 rounded-full bg-[#f4f1e8] border border-stone-200 flex items-center justify-center group-hover:border-[#9b4819] transition-colors">
                                    <MapPin size={18} className="text-stone-500 group-hover:text-[#9b4819]" />
                                </div>
                                <span className="font-mono text-[15px]">Dhaka, Bangladesh</span>
                            </div>
                        </div>
                    </div>
